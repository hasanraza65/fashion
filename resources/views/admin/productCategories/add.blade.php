				   ...
				   <hr>
				    <form  method="POST" action="{{route('productcategories.store')}}" enctype="multipart/form-data">  
					 ...
					 <div class="form-group row">
					  ...
					  <div class="col-sm-10">
                        <input type="text" class="form-control" id="input-21" placeholder="Category Name" name="name" value="" required autocomplete="name" autofocus>
					  </div>
                     </div>
                     ...
                     <div class="form-group row">
					  ...
					  <div class="col-sm-10">
                        <input type="file"  id="input-22" name="icon" value="">
					  </div>
                     </div>
