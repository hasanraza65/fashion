				   ...
				   <hr>
				    <form  method="POST" action="{{route('extra.store')}}" enctype="multipart/form-data">  
					 ...
					 <div class="form-group row">
					  ...
					  <div class="col-sm-10">
                        <input type="text" class="form-control" id="input-21" placeholder="Enter Trim Name" name="name" value="" required autocomplete="name" autofocus>
                    ...
                    <div class="form-group row">
					  ...
					  <div class="col-sm-10">
                        <input type="text" class="form-control" id="input-21" placeholder="Enter Trim Price" name="price" value="" required autocomplete="name" autofocus>
