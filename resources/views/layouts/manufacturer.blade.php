...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    ...
    <div class="brand-logo">
        <a href="{{ route('home') }}">
            ...
            <h5 class="logo-text">Fashion Manufacturer</h5>
        </a>
    </div>
    <div class="user-details">
        <div class="media align-items-center user-pointer collapsed" data-toggle="collapse" data-target="#user-dropdown">
            @if(Auth::user()->avatar)
            <div class="avatar"><img class="mr-3 side-user-img" src="{{ URL::to('/') }}/images/avatar/{{ Auth::user()->avatar }}" alt="user avatar"></div>
        ...
        <div id="user-dropdown" class="collapse">
            ...
            <li><a href="{{route('manufacturer-web.edit',Auth::user()->id)}}"><i class="icon-settings"></i> Setting</a></li>
...
<!--        <li>
        ...
        <li>
            <a href="{{route('manufacturer-web.index')}}" class="waves-effect">
        ...
        <li>
            ...
            <ul class="sidebar-submenu">
            <li><a href="{{route('order-manufacturer.show',Auth::user()->id)}}"><i class="zmdi zmdi-long-arrow-right"></i> Pending Orders</a></li>
            <li><a href="{{route('order-manufacturer.edit',Auth::user()->id)}}"><i class="zmdi zmdi-long-arrow-right"></i> Compeleted Orders</a></li>
            </ul>
        </li>
        
            <li>
            <a href="javaScript:void();" class="waves-effect">
                <i class="zmdi zmdi-view-dashboard"></i> <span>My Transaction</span><i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="sidebar-submenu">
                <li><a href="{{route('manufacturer-transaction.index')}}"><i class="zmdi zmdi-long-arrow-right"></i> View Transactions</a></li>
            </ul>
        </li>
...
<!--                        <li class="nav-item dropdown-lg">
                       ...
                       <li class="nav-item">
                            ...
                            @if(Auth::user()->avatar)
            <span class="user-profile"><img src="{{ URL::to('/') }}/images/avatar/{{ Auth::user()->avatar }}" class="img-circle" alt="user avatar"></span>
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li class="dropdown-item user-details">
                                    <a href="javaScript:void();">
                                        ...
                                        <div class="avatar"><img class="align-self-start mr-3" src="{{ URL::to('/') }}/images/avatar/{{ Auth::user()->avatar }}" alt="user avatar"></div>
                                        @else
